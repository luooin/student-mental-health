<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="调查问卷名称" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="调查问卷名称" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="调查问卷名称" prop="name">
              <el-input v-model="ruleForm.name" 
                placeholder="调查问卷名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="调查问卷状态" prop="status">
          <el-select :disabled="ro.status" v-model="ruleForm.status" placeholder="请选择调查问卷状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="调查问卷状态" prop="status">
              <el-input v-model="ruleForm.status?'启用':'禁用'" 
                placeholder="调查问卷状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	status : false,
      ...
      rules: {
          name: [
                { required: true, message: '调查问卷名称不能为空', trigger: 'blur' },
          ],
          time: [
          ...
          status: [
                { required: true, message: '调查问卷状态不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
      }
    };
