    ...
    <div v-if="!showFlag">
      ...
      <div class="table-content">
        ...
        >
          ...
          <el-table-column prop="name" header-align="center" align="center" sortable label="调查问卷"></el-table-column>
          <el-table-column
            prop="time"
            header-align="center"
            align="center"
          ...
          <!-- <el-table-column prop="status" header-align="center" align="center" sortable label="调查问卷状态">
