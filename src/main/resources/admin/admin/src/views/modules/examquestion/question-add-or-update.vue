<template>
  <div>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item label="选择调查问卷" prop="paperid">
      ...
      <el-form-item label="心理试题" prop="questionname">
        <el-input
          style="width:600px;"
          type="textarea"
          min="1"
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        questionname: [
          { required: true, message: "心理试题内容不能为空", trigger: "blur" }
        ],
        type: [{ required: true, message: "请选择心理试题类型", trigger: "blur" }],
