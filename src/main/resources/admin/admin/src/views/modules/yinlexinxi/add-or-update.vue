<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="音乐名称" prop="yinlemingcheng">
          <el-input v-model="ruleForm.yinlemingcheng" 
              placeholder="音乐名称" clearable  :readonly="ro.yinlemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="音乐名称" prop="yinlemingcheng">
              <el-input v-model="ruleForm.yinlemingcheng" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="音乐类型" prop="yinleleixing">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.yinpin" label="音频" prop="yinpin">
          <file-upload
          tip="点击上传音频"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.yinpin" label="音频" prop="yinpin">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.yinpin)">预览</el-button>
          </el-form-item>
        </div>    
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.mv" label="mv" prop="mv">
          <file-upload
          tip="点击上传mv"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.mv?ruleForm.mv:''"
          @change="mvUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.mv" label="mv" prop="mv">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.mv)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='yinlemingcheng'){
            this.ruleForm.yinlemingcheng = obj[o];
	    this.ro.yinlemingcheng = true;
            continue;
          }
          if(o=='yinleleixing'){
	...
	this.ruleForm.geci = this.ruleForm.geci.replace(reg,'../../../springboot9701n/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.mv!=null) {
		this.ruleForm.mv = this.ruleForm.mv.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    mvUploadChange(fileUrls) {
	this.ruleForm.mv = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
