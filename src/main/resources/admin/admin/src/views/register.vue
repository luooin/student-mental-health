  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='xinlijiaoshi'" class="input-group">
			   <div class="label">教师工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshigonghao" class="input" type="text" placeholder="教师工号">
			   </div>
			 </div> -->
			<el-form-item label="教师工号" class="input" v-if="tableName=='xinlijiaoshi'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='xinlijiaoshi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='xinlijiaoshi'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="教师姓名" class="input" v-if="tableName=='xinlijiaoshi'">
			...
			<el-form-item label="职称" class="input" v-if="tableName=='xinlijiaoshi'">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='xinlijiaoshi'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.jiaoshigonghao) && `xinlijiaoshi` == this.tableName){
        this.$message.error(`教师工号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `xinlijiaoshi` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `xinlijiaoshi` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.jiaoshixingming) && `xinlijiaoshi` == this.tableName){
        this.$message.error(`教师姓名不能为空`);
        return
      }
      if((!this.ruleForm.dianhua) && `xinlijiaoshi` == this.tableName){
        this.$message.error(`电话不能为空`);
        return
      }
      if(`xinlijiaoshi` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
